...
public class GetAssemblyCandidatesNetworkTask extends AsyncTask<Void, Void, String[]> {
    ...
    public GetAssemblyCandidatesNetworkTask(String assemblyName, Context activityContext, ProgressBar progressBar, View formView, AsyncResponse asyncResponse) {
    ...
    protected String[] doInBackground(Void... voids) {
        ...
        try {
            ...
            httpGet = new HttpGet(ServerSpecification.serverEndPoint+"/assemblyCandidates/" + assemblyName + ".json");
