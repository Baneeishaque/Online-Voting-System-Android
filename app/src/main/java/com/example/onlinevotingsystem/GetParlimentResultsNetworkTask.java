...
public class GetParlimentResultsNetworkTask extends AsyncTask<Void, Void, String[]> {
    ...
    public GetParlimentResultsNetworkTask(String parlimentName, Context activityContext, ProgressBar progressBar, View formView, AsyncResponse asyncResponse) {
    ...
    protected String[] doInBackground(Void... voids) {
        ...
        try {
            ...
            httpGet = new HttpGet(ServerSpecification.serverEndPoint + "/parlimentVotes/" + parlimentName + ".json");
