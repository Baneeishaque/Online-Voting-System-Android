...
public class GetAssemblyResultsNetworkTask extends AsyncTask<Void, Void, String[]> {
    ...
    public GetAssemblyResultsNetworkTask(String assemblyName, Context activityContext, ProgressBar progressBar, View formView, AsyncResponse asyncResponse) {
    ...
    protected String[] doInBackground(Void... voids) {
        ...
        try {
            ...
            httpGet = new HttpGet(ServerSpecification.serverEndPoint+"/assemblyVotes/" + assemblyName + ".json");
